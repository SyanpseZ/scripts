...
elseif game.PlaceId == 12179321613 then --TH3
    loadstring(game:HttpGet("https://raw.githubusercontent.com/SyanpseZ/scripts/refs/heads/main/Scripts/TrueHeart3.lua))()
else
